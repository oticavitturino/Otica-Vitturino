    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                    ...
                    .requestMatchers(HttpMethod.POST, "/occurrences/respond").hasRole("ADMIN")
                    ...
                    .requestMatchers(HttpMethod.DELETE, "/orders/deleteOrder").hasRole("ADMIN")
                    ...
                    .requestMatchers(HttpMethod.GET, "/message-template/getAllTemplates").hasRole("ADMIN")
                    ...
                    .requestMatchers(HttpMethod.GET, "/scheduling/mySchedulings").hasRole("CUSTOMER")
                    .requestMatchers(HttpMethod.GET, "/orders/myOrders").hasRole("CUSTOMER")
                    ...
                    .requestMatchers(HttpMethod.GET, "/customer/score").hasAnyRole("ADMIN", "CUSTOMER")
